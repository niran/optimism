...
func (_L1Block *L1BlockCaller) DataGasPerToken(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _L1Block.contract.Call(opts, &out, "dataGasPerToken")
...
//
// Solidity: function dataGasPerToken() view returns(uint32)
func (_L1Block *L1BlockSession) DataGasPerToken() (uint32, error) {
	return _L1Block.Contract.DataGasPerToken(&_L1Block.CallOpts)
}

// DataGasPerToken is a free data retrieval call binding the contract method 0x7cea2dcf.
//
// Solidity: function dataGasPerToken() view returns(uint32)
func (_L1Block *L1BlockCallerSession) DataGasPerToken() (uint32, error) {
	return _L1Block.Contract.DataGasPerToken(&_L1Block.CallOpts)
}
