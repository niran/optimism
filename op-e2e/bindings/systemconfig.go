...
// DataGasPerToken is a free data retrieval call binding the contract method 0x7cea2dcf.
//
// Solidity: function dataGasPerToken() view returns(uint32)
func (_SystemConfig *SystemConfigCaller) DataGasPerToken(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _SystemConfig.contract.Call(opts, &out, "dataGasPerToken")
...
//
// Solidity: function dataGasPerToken() view returns(uint32)
func (_SystemConfig *SystemConfigSession) DataGasPerToken() (uint32, error) {
	return _SystemConfig.Contract.DataGasPerToken(&_SystemConfig.CallOpts)
}

// DataGasPerToken is a free data retrieval call binding the contract method 0x7cea2dcf.
//
// Solidity: function dataGasPerToken() view returns(uint32)
func (_SystemConfig *SystemConfigCallerSession) DataGasPerToken() (uint32, error) {
	return _SystemConfig.Contract.DataGasPerToken(&_SystemConfig.CallOpts)
}
...
func (_SystemConfig *SystemConfigSession) Initialize(_owner common.Address, _basefeeScalar uint32, _blobbasefeeScalar uint32, _batcherHash [32]byte, _gasLimit uint64, _unsafeBlockSigner common.Address, _config IResourceMeteringResourceConfig, _batchInbox common.Address, _addresses SystemConfigAddresses, _l2ChainId *big.Int, _superchainConfig common.Address, _dataGasPerToken uint32) (*types.Transaction, error) {
	return _SystemConfig.Contract.Initialize(&_SystemConfig.TransactOpts, _owner, _basefeeScalar, _blobbasefeeScalar, _batcherHash, _gasLimit, _unsafeBlockSigner, _config, _batchInbox, _addresses, _l2ChainId, _superchainConfig, _dataGasPerToken)
}
...
// SetDataGasPerToken is a paid mutator transaction binding the contract method 0xf7cf8b4f.
//
// Solidity: function setDataGasPerToken(uint32 _dataGasPerToken) returns()
func (_SystemConfig *SystemConfigTransactor) SetDataGasPerToken(opts *bind.TransactOpts, _dataGasPerToken uint32) (*types.Transaction, error) {
	return _SystemConfig.contract.Transact(opts, "setDataGasPerToken", _dataGasPerToken)
}

// SetDataGasPerToken is a paid mutator transaction binding the contract method 0xf7cf8b4f.
//
// Solidity: function setDataGasPerToken(uint32 _dataGasPerToken) returns()
func (_SystemConfig *SystemConfigSession) SetDataGasPerToken(_dataGasPerToken uint32) (*types.Transaction, error) {
	return _SystemConfig.Contract.SetDataGasPerToken(&_SystemConfig.TransactOpts, _dataGasPerToken)
}

// SetDataGasPerToken is a paid mutator transaction binding the contract method 0xf7cf8b4f.
//
// Solidity: function setDataGasPerToken(uint32 _dataGasPerToken) returns()
func (_SystemConfig *SystemConfigTransactorSession) SetDataGasPerToken(_dataGasPerToken uint32) (*types.Transaction, error) {
	return _SystemConfig.Contract.SetDataGasPerToken(&_SystemConfig.TransactOpts, _dataGasPerToken)
}
