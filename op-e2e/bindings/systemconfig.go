...
func (_SystemConfig *SystemConfigCaller) CalldataGasPerCompressedByte(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _SystemConfig.contract.Call(opts, &out, "calldataGasPerCompressedByte")
...
//
// Solidity: function calldataGasPerCompressedByte() view returns(uint32)
func (_SystemConfig *SystemConfigSession) CalldataGasPerCompressedByte() (uint32, error) {
	return _SystemConfig.Contract.CalldataGasPerCompressedByte(&_SystemConfig.CallOpts)
}

// CalldataGasPerCompressedByte is a free data retrieval call binding the contract method 0xa571b506.
//
// Solidity: function calldataGasPerCompressedByte() view returns(uint32)
func (_SystemConfig *SystemConfigCallerSession) CalldataGasPerCompressedByte() (uint32, error) {
	return _SystemConfig.Contract.CalldataGasPerCompressedByte(&_SystemConfig.CallOpts)
}
...
func (_SystemConfig *SystemConfigSession) Initialize(_owner common.Address, _basefeeScalar uint32, _blobbasefeeScalar uint32, _batcherHash [32]byte, _gasLimit uint64, _unsafeBlockSigner common.Address, _config IResourceMeteringResourceConfig, _batchInbox common.Address, _addresses SystemConfigAddresses, _l2ChainId *big.Int, _superchainConfig common.Address, _calldataGasPerCompressedByte uint32) (*types.Transaction, error) {
	return _SystemConfig.Contract.Initialize(&_SystemConfig.TransactOpts, _owner, _basefeeScalar, _blobbasefeeScalar, _batcherHash, _gasLimit, _unsafeBlockSigner, _config, _batchInbox, _addresses, _l2ChainId, _superchainConfig, _calldataGasPerCompressedByte)
}
...
// SetCalldataGasPerCompressedByte is a paid mutator transaction binding the contract method 0xd88762b2.
//
// Solidity: function setCalldataGasPerCompressedByte(uint32 _calldataGasPerCompressedByte) returns()
func (_SystemConfig *SystemConfigTransactor) SetCalldataGasPerCompressedByte(opts *bind.TransactOpts, _calldataGasPerCompressedByte uint32) (*types.Transaction, error) {
	return _SystemConfig.contract.Transact(opts, "setCalldataGasPerCompressedByte", _calldataGasPerCompressedByte)
}

// SetCalldataGasPerCompressedByte is a paid mutator transaction binding the contract method 0xd88762b2.
//
// Solidity: function setCalldataGasPerCompressedByte(uint32 _calldataGasPerCompressedByte) returns()
func (_SystemConfig *SystemConfigSession) SetCalldataGasPerCompressedByte(_calldataGasPerCompressedByte uint32) (*types.Transaction, error) {
	return _SystemConfig.Contract.SetCalldataGasPerCompressedByte(&_SystemConfig.TransactOpts, _calldataGasPerCompressedByte)
}

// SetCalldataGasPerCompressedByte is a paid mutator transaction binding the contract method 0xd88762b2.
//
// Solidity: function setCalldataGasPerCompressedByte(uint32 _calldataGasPerCompressedByte) returns()
func (_SystemConfig *SystemConfigTransactorSession) SetCalldataGasPerCompressedByte(_calldataGasPerCompressedByte uint32) (*types.Transaction, error) {
	return _SystemConfig.Contract.SetCalldataGasPerCompressedByte(&_SystemConfig.TransactOpts, _calldataGasPerCompressedByte)
}
