...
func TestNewDeploySuperchainScript(t *testing.T) {
	t.Run("should not fail with current version of DeploySuperchain contract", func(t *testing.T) {
		...
		require.NotEqual(t, output.ProtocolVersionsImpl, common.Address{})
		require.NotEqual(t, output.ProtocolVersionsProxy, common.Address{})
		require.NotEqual(t, output.SuperchainConfigImpl, common.Address{})
		require.NotEqual(t, output.SuperchainConfigProxy, common.Address{})
		require.NotEqual(t, output.SuperchainProxyAdmin, common.Address{})
	})
}
